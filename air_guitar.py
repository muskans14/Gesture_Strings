...
SAMPLE_RATE = 44100
MIN_STRUM_FORCE = 20
GLOBAL_STRING_DELAY = 0.15  # seconds between string triggers
            ...
            if ser.in_waiting:
                try:
                    ...
                    if ":" in line:
                        ...
                        if force > MIN_STRUM_FORCE and (now - last_global_play_time > GLOBAL_STRING_DELAY):
                            for s in VIRTUAL_STRINGS: 
                                ...
                                if prev_roll != -999:
                                    ...
                                    if down or up:
                                        ...
                                        last_global_play_time = now
                                        print(f"🎵 {s['note']}")
                                        break  # ONLY one string
